...
'cookie_pre' => 'QzydA_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'tpl_referesh' => 1,
'tpl_edit'=> 1, //0,//是否允许在线编辑模板

//附件相关配置
'upload_path' => PHPCMS_PATH.'uploadfile/',
'upload_url' => 'http://localhost/construction/uploadfile/', //附件路径
'attachment_stat' => '1',//是否记录附件使用状态 0 统计 1 统计， 注意: 本功能会加重服务器负担

'js_path' => 'http://localhost/construction/statics/js/', //CDN JS
'css_path' => 'http://localhost/construction/statics/css/', //CDN CSS
'img_path' => 'http://localhost/construction/statics/images/', //CDN img
'app_path' => 'http://localhost/construction/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => 'Y9qNSOGzhkUiY87p089o', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '1',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id	
'phpsso_api_url' => 'http://localhost/construction/phpsso_server',	//接口地址
'phpsso_auth_key' => 'oEzLeR19OdZgEZAESUzxYFlvGg8S8QAg', //加密密钥
